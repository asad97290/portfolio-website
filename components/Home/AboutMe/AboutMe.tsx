...
export default function AboutMe(props) {
  const technologies = [
    ["React.js", "Node.js", "JavaScript", "Typescript","AWS", "Docker", "Git", "MongoDb"],
    ["hardhat","foundry","Web3.js","Ethers.js","Wagmi","Solidity"],
  ];
  return (
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                I enrolled in Computer Science Bachelors degree program. Little did I know that programming skills
